...
#
#     test_res <- test_hadex_data(hadex_dat, tests = list(test_houde,
#                                                         test_hdx_analyzer))
#
#     expect_equal(test_res,
#                  structure(list(Test = c("Houde",
#                                          "Deuteros lm identity continuous",
#                                          "Deuteros lm identity categorical",
#                                          "Deuteros lm log continuous"),
#                                 State_1 = c("CD160", "CD160",
#                                             "CD160", "CD160"),
#                                 State_2 = c("CD160_HVEM", "CD160_HVEM",
#                                             "CD160_HVEM", "CD160_HVEM"),
#                                 Significant_difference = c(TRUE, FALSE,
#                                                            TRUE, FALSE),
#                                 Sequence = c("INITSSASQEGTRLN",
#                                              "INITSSASQEGTRLN",
#                                              "INITSSASQEGTRLN",
#                                              "INITSSASQEGTRLN")),
#                            row.names = c(NA, -4L),
...
#
#     expect_error(test_hadex_data(hadex_dat, tests = list(test_houde,
#                                                          test_hdx_analyzer)),
...
#                                  tests = list(test = function(
#                                      data,
#                                      significance_level = 0.05) stop("Error")
#                                  )),
